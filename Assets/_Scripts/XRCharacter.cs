...
namespace ThurtwingsGames.XR.VRCharacterController
{
    public class XRCharacter : MonoBehaviour
    {
        ...
        // References
        public Transform cameraHead = null , mesh = null;
        ...
        public void Jump(InputDevice device)
        {
            if (device.TryGetFeatureValue(CommonUsages.primaryButton, out bool jumpPressed))
            {
                if (jumpPressed == true)
                {
        ...
        {
            // Joystick direction
            Vector3 newDirection = new(joystickDirection.x, 0, joystickDirection.y);

            // Look rotate
            Vector3 headRotation = new(0, cameraHead.transform.eulerAngles.y, 0);
        ...
        private void Animate()
        {
            ...
            animator.SetFloat("Vertical", blend);
        }
    }
}
